...
const Cultpasslive = () => {
  return (
    <div>
      ...
      consequuntur quas impedit ipsa quae illo expedita. Saepe, illum. Laborum
      eaque cumque voluptatem obcaecati eveniet architecto corporis, repellendus
      dolorum vel eligendi eius, nulla qui! Eveniet est odio ex, tempore
      assumenda fugiat consequatur! Eum voluptates voluptate quibusdam beatae
      vitae ipsum, saepe, atque architecto itaque sint aliquid consequuntur
      porro dolor sit ipsa ullam fuga molestias fugit provident rem cum sunt
      tempore. Iure, sunt consequatur hic nobis dolores temporibus? Quia iste,
      officiis rem quaerat, delectus fugit reprehenderit neque non quibusdam,
      assumenda at eligendi odit cupiditate maiores sapiente facere! Dolorem
      quod sint nihil maxime pariatur, sit error quam voluptates et, explicabo
      quae sequi quasi iure praesentium sapiente reprehenderit similique dolorum
      perferendis quo dicta? Nisi quisquam expedita laboriosam quia pariatur.
      Eaque earum excepturi eveniet voluptates, repudiandae natus doloremque
      reprehenderit est animi. Adipisci doloremque dolorem praesentium alias
      aperiam corrupti perspiciatis quaerat ratione eaque quam, culpa atque aut
      necessitatibus assumenda totam iure magni ullam earum illum possimus
      fugiat, optio nobis! Incidunt perspiciatis maxime ipsa dolore ullam, nemo
      alias expedita distinctio, sit totam doloribus natus? Odio minus
      aspernatur ea repellendus quibusdam, illum quia libero iure laboriosam
      corrupti nisi nobis, rem nam!
    </div>
  );
};

export default Cultpasslive;
