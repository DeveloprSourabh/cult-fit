    ...
    <>
      ...
      <div style={{ background: "rgb(31, 75, 87)" }}>
        ...
        <div style={{ background: "rgb(31, 75, 87)" }}>
          ...
          <div
            style={{ position: "absolute", top: "57rem" }}
            className="splogo1"
          >
          ...
          <div style={{ position: "relative", top: "63rem" }} className="end">
            ...
            <div className="sou">
              ...
              <div className="sopnic">
                ...
                <p className="sopnic2">
                  <a href="">+</a> Free 2 month pack extension
                </p>
              </div>
              <div className="sopbt1">
                <button className="sopbtn1">BUY NOW</button>
            ...
            <div className="sou">
              <div className="sop">
                <div className="dt">3</div>
                <div className="mt">MONTHS</div>
              </div>
              <div className="sop2">
                <div className="ct">4499</div>
                <div className="cnum">₹ 3299</div>
                <div className="tem">1100 per month</div>
              </div>
              <hr />
              <div className="sopnic">
                <p className="sopnic1">
                  <a href=""> +</a> Flat 20% off
                </p>
                <p className="sopnic2">
                  <a href=""> +</a> Only Today | Additional Rs.300 off applied.
                </p>
                <p className="sopnic2">
                  <a href=""> +</a>Free 2 month pack extension
                </p>
          ...
          <div className="iiiimg">
            <img
              src="https://cdn-images.cure.fit/www-curefit-com/image/upload/fl_progressive,f_auto,q_auto:eco,w_1440,ar_1360:150/dpr_2/image/vm/26c92f95-0e2b-4538-97e1-c9ad81b1cf8a.png"
              alt=""
              className="voi"
            />
          </div>
        ...
        <div
          style={{ marginTop: "62rem", paddingLeft: "8rem" }}
          className="ffter"
        >
