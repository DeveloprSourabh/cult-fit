          ...
          <div className="row nic1">
            <div className="col-6">
              ...
              <div className="nicds2">
                <div className="nicimgd1">
                  <img
                    src="https://cdn-images.cure.fit/www-curefit-com/image/upload/c_fill,w_968,ar_1.17,q_auto:eco,dpr_1.25,f_auto,fl_progressive/image/vm/7b33200a-64d6-4432-9a30-260bb61ab2b1.png"
                    alt=""
                    className="nicimg2"
                  />
