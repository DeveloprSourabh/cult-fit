  ...
  return (
    <>
      ...
      <div className="tp">
        <div className="cmn1">
          <div className="cmn2">
            <h3 className="cmn1h3">Unlimited Access to</h3>
          </div>
          ...
          <div className="cmn1h5">
            <h5 className="cmnh51">ELITE & PRO GYMS</h5>
          </div>
        </div>

        <div className="cmn3">
          <h3 className="cmn2h3">At center Group Classes</h3>
        </div>

        <div className="cmn4">
          <div className="h32">Multiple workout formats</div>
        </div>
        ...
        <div className="cmn5">
          <div className="ay">
            ...
            <div className="cmn2h2">
              <h2 className="cmnh22">AT HOME</h2>
            </div>

            <div className="cmn2h5">
              <h5 className="cmnh52">LIVE WORKOUTS</h5>
            </div>
          </div>
        </div>
        <div className="cmn6">
          ...
          <div className="cmn3h3">
            <h5 className="cmnh33">Workout plans</h5>
          </div>
        </div>
      </div>
    </>
